...
function GreyReport() {
  ...
  function handleSubmit(e) {
    ...
    axios.post("http://localhost:3006/grey_report", form)
      .then(res => {
        console.log(res);
    ...
    <form onSubmit={handleSubmit}>
      <div class="login">
        <div class="form">
          ...
          <input type="number" value={form.meters} onChange={handleChange} name="meters" placeholder="Meters" required />
          <input type="number" value={form.points} onChange={handleChange} name="points" placeholder="points" required />
          <input type="number" value={form.order_no} onChange={handleChange} name="order_no" placeholder="Order Number" required />
          <input type="number" value={form.repairable} onChange={handleChange} name="repairable" placeholder="Repairable" required />
          <input type="number" value={form.grade} onChange={handleChange} name="grade" placeholder="Grade" required />
